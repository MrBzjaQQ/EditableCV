...
namespace EditableCV_backend.Migrations
{
    ...
    [Migration("20240513112913_Modify_FilesRepository")]
    partial class Modify_FilesRepository
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EditableCV.Domain.Models.FileModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EditableCV.Domain.Models.CommonInfo", b =>
                {
                    b.HasOne("EditableCV.Domain.Models.FileModel", "Photo")
                        .WithMany()
